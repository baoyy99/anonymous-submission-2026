...
parser.add_argument('--TrALoss_beta', type=float, default=1, help='0 < beta < 1,Loss when predictions are less than or equal to the trend')
 #TQALoss
  
parser.add_argument('--TQALoss_alpha', type=float, default=0, help='0 < alpha < 1,Loss when predictions are greater than the trend')
parser.add_argument('--TQALoss_beta', type=float, default=1, help='0 < beta < 1,Loss when predictions are less than or equal to the trend')
parser.add_argument('--TQALoss_gamma', type=float, default=0.3, help='ema alpha')
parser.add_argument('--TQALoss_q', type=float, default=0.52, help='q')
...
if args.is_training:
    for ii in range(args.itr):
        ...
        setting = '{}_a{}_b{}_g{}_q{}_{}_{}_{}_ft{}_sl{}_pl{}_cycle{}_epo{}_{}_{}_lr{}_seed{}'.format(
            args.loss,          
                args.TQALoss_alpha,
                args.TQALoss_beta,
                args.TQALoss_gamma,
    ...
    setting = '{}_a{}_b{}_g{}_q{}_{}_{}_{}_ft{}_sl{}_pl{}_cycle{}_epo{}_pat{}_bat{}_lr{}_seed{}'.format(
            # args.model_id,
            args.loss,          
            args.TQALoss_alpha,
            args.TQALoss_beta,
